    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category_items', to='main.category')),
            ],
            options={
                'db_table': 'item',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchases', to='main.item')),
        ...
        migrations.AddField(
            model_name='basket',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='baskets', to='main.status'),
        ),
        migrations.AddField(
            model_name='user',
            name='favourite_categories',
            field=models.ManyToManyField(db_table='user_favourite_category', to='main.Category', verbose_name='Favourite category'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
